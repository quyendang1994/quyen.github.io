...
// Lấy thông tin cá nhân hóa từ URL
...
document.querySelector('.Description .modal-title').innerHTML = `<i class="far fa-comment-alt"></i>&nbsp;Nhịp tim của ${fromName} như vậy là tại vì:`;
document.querySelector('.Description .modal-body').innerHTML = `${fromName} thích ${toName} đó <i class="fas fa-heart"></i> `;
var author = document.querySelector('.author .me');author.style.opacity = "0.5";

author.innerHTML = "Mọi thắc mắc bạn có thể liên hệ<a href='https://www.facebook.com/DangDinhQuyen04<a>";
...
window.addEventListener('load', function() {
	...
	if (audio) {
		audio.play().catch(function(error) {
			console.log("Autoplay bị trình duyệt chặn. Nhạc sẽ phát sau khi bạn tương tác với trang.");
		});
	}
});
